...
print("--- Running Validation for logic.py ---")
...
try:
    ...
    check(
        all(s["subject"] == "Science" for s in standards),
...
try:
    ...
    check(
        not mastered_found, "Mastered standard 'VA.MATH.K.k.1' was returned. It should be filtered."
    )
